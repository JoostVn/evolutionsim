...
from NEW_geometry import Polygon
...
class Herbivore:
    ...
    """
    Bot that gains fitness from food collection and tries to avoid barriers.
    Works with the FoodSupply and Barriers Objects.
    """
    ...
    def update(self, food, food_distances, barriers):
        ...
        sensor_input_dict = {
            ...
            'barrier_polygons': barriers.polygons}
